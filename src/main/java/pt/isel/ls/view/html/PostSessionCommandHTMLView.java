...
public class PostSessionCommandHTMLView extends CommandViewHTML {
    private static final String TITLE = "PostSession";
    private static final String DEFAULT_CONTENT = "<h1>Session Posted!</h1>\n" +
            "<p>ID: {0}</p>\n";
