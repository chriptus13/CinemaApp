...
public class GetSessionsTodayInCinemaCommandHTMLView extends CommandViewHTML {
    ...
    public String getBackButton(CommandResult commandResult) {
        ...
        return MessageFormat.format(BACK_BUTTON, s.getTheater().getCinema().getId(), Utils.dateToSpecialString(new Date(System.currentTimeMillis()), -1),
                Utils.dateToSpecialString(new Date(System.currentTimeMillis()), 1));
    }
