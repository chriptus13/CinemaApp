...
/**
 * Command to get all the Sessions in a Theater
 */
public class GetSessionsInTheaterCommand implements Command {
    ...
    public CommandResult execute(Map<String, Object> args, Repository repo) throws CommandException {
        try {
            ...
            Collection<Session> l = repo.getSessionsInTheater(cID, tID);
    ...
    public String getDescription() {
        return "GET /cinemas/{cid}/theaters/{tid}/sessions\n" +
                "\tGet all sessions in theater with tid";
    }
}
