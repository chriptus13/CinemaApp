...
public class TestGetCinemaCommand {

    @Test
    public void getCinemaWithoutExceptionTest() throws CommandException {
        // Arrange
        Map<String, Object> parametersTestMap = new HashMap<>();
        parametersTestMap.put("cid", 0);

        // Action
        Object res = new GetCinemaCommand().execute(parametersTestMap, TEST_REPO).getValue();
    ...
    public void incorrectTypeOfParametersTest() throws CommandException {
        ...
        // Action & Assert
        new GetCinemaCommand().execute(parametersTestMap, TEST_REPO);
    }
