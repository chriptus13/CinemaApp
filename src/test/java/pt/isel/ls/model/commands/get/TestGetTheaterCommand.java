...
public class TestGetTheaterCommand {

    @Test
    public void getTheaterWithoutExceptionTest() throws CommandException {
        // Arrange
        ...
        // Action
        Object res = new GetTheaterCommand().execute(parametersTestMap, TEST_REPO).getValue();
    ...
    public void incorrectTypeOfParametersTest() throws CommandException {
        ...
        parametersTestMap.put("tid", "Test");

        // Action & Assert
        new GetTheaterCommand().execute(parametersTestMap, TEST_REPO);
    }
