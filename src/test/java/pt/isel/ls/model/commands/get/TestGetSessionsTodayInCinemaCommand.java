...
public class TestGetSessionsTodayInCinemaCommand {

    @Test
    public void getSessionsTodayInCinemaWithoutExceptionTest() throws CommandException {
        // Arrange
        Map<String, Object> parametersTestMap = new HashMap<>();
        parametersTestMap.put("cid", 0);

        // Action
        Object res = new GetSessionsTodayInCinemaCommand().execute(parametersTestMap, TEST_REPO).getValue();
    ...
    public void incorrectTypeOfParametersTest() throws CommandException {
        ...
        // Action & Assert
        new GetSessionsTodayInCinemaCommand().execute(parametersTestMap, TEST_REPO);
    }
